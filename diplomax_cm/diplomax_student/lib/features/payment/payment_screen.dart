...
class _PaymentState extends State<PaymentScreen> {
  ...
  Future<bool> _pollPaymentStatus({
    ...
    for (int attempt = 1; attempt <= 12; attempt++) {
      ...
      setState(() {
        _statusMessage =
            '${AppStrings.of(context).tr('Vérification du statut', 'Checking status')} ($attempt/12)...';
      });
                    ...
                    child: _processing
                        ...
                        : Row(
                            ...
                            children: [
                              ...
                              Text(
                                  '${AppStrings.of(context).tr('Payer', 'Pay')} ${_selectedProduct != null ? "${_selectedProduct!.price} FCFA" : ""}',
