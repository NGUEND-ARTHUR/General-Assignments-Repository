...
- Name: web.ui.e2e.spec.js >> UniAttend Web UI MVP - lecturer and admin journeys >> admin can access analytics and manage session actions
- Location: tests\web.ui.e2e.spec.js:89:3
