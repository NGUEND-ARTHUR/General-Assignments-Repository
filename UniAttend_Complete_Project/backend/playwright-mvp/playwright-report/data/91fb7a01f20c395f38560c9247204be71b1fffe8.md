...
- Name: web.ui.e2e.spec.js >> UniAttend Web UI MVP - super admin journey >> super admin can open approvals and user management routes
- Location: tests\web.ui.e2e.spec.js:108:3
