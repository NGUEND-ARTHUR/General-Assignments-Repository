...
- Name: web.ui.e2e.spec.js >> UniAttend Web UI MVP - student journey >> student can sign in, switch tabs, inspect profile, and sign out
- Location: tests\web.ui.e2e.spec.js:42:3
