...
- Name: web.ui.e2e.spec.js >> UniAttend Web UI MVP - lecturer and admin journeys >> lecturer sees session controls and dashboard buttons
- Location: tests\web.ui.e2e.spec.js:70:3
